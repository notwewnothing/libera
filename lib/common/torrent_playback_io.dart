...
// Import the native impl directly (this file is native-only): the facade's
// default export is the web stub, which lacks the streaming-only API below.
import 'package:libera/services/torrent/torrent_stream_service_io.dart';
